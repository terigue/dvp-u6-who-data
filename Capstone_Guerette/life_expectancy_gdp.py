...
GDP chart shows a great disparity between countries. LEABY shows a more even distribution across countries.
...
Zimbabwe shows the biggest change in LEABY over time. This takes place between 2006 and 2015. Zimbabwe also shows the least amount of change to GDP. There is some correlation between LEABY and a country's GDP.
...
China moves the most along x axis. Zimbabwe moves the most along the Y axis. Not surprising, based on the data.
...
highest GDP seen in China & US. lowest in Chile & Zimbabwe
...
highest LEABY see in Germany & Chile. lowest in Zimbabwe.
...
get_ipython().set_next_input('What happened in Zimbabwe between in the past 10 years that increased the life expectancy');get_ipython().run_line_magic('pinfo', 'expectancy')
